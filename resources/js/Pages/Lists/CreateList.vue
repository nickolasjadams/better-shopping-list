            ...
            <form @submit.prevent="submit">
                <div class="grid gap-6 mb-6 md:grid-cols-1">
                    <div>
                        ...
                        <input v-model="form.name" v-bind:placeholder="rotatingPlaceholder[rotatingPlaceholderIndex]" type="text" id="name" name="name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>
                    </div>
...
<!--            <Link v-if="$page.props.auth.user" :href="route('lists')" class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Lists</Link>-->
